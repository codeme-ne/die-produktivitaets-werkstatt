...
> Beispiel: Lukas (Selbständig)
>
> ![][image1]

> Beispiel: Lukas (Kundenberater & Agile Coach)
>
> ![][image2]

> Beispiel: Teilzeit Arbeiter/-in
>
> ![][image3]
...
<details>
  <summary>❓ Was ist mit Spontanität? Wird das Leben dadurch nicht zu sehr strukturiert?</summary>
  <p>Die Struktur schafft tatsächlich Freiheit. Wenn du weißt, dass deine Prioritäten berücksichtigt werden, kannst du spontaner sein, ohne dich schuldig oder gestresst zu fühlen.</p>
  </details>

<details>
  <summary>❓ Was bringt es, einen Plan zu erstellen, wenn er nie genau so funktioniert, wie man es beabsichtigt hat?</summary>
  <p>Betrachte es wie einen Schlachtplan. Keine Schlacht verlief je nach Plan, aber keine Schlacht wurde je ohne einen gewonnen. Der Wert liegt nicht in der perfekten Ausführung, sondern in der Absichtsbestimmung. Die Erstellung eines Plans hilft dir, deine Werte und das, was dir wichtig ist, zu klären. Selbst wenn dir das Leben einen Schlag ins Gesicht verpasst (was es tun wird), hilft dir dieser Nordstern, wieder auf Kurs zu kommen.</p>
  </details>
