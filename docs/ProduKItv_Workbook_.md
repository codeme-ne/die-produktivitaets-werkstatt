...
**Was du mit diesem Leitfaden erreichen wirst**

---

Was ich mit dir teilen möchte, ist **eine neue Denkweise.**

Ja, ich werde dir sofort einsatzbereite Prompts geben.

Aber sobald du die Methode verstanden hast, die ich hier teile, kannst du sie immer wieder bei all deinen Aufgaben anwenden – beim Schreiben, Brainstorming, bei der Content-Erstellung, bei Präsentationen und mehr.

Es ist, als hättest du **24/7 ein KI-Teammitglied direkt neben dir.**

Und das ist unendlich wertvoller.

**Warum das Schreiben von KI-Prompts so schwer erscheint — und wie du das ändern kannst**

---

Lass uns zuerst darüber sprechen.

Als ich anfing, KI zu nutzen, fand ich es anfangs überwältigend.

Nach Gesprächen mit vielen Menschen wurde mir klar, warum: Wir denken, wir müssten den "perfekten Prompt" schreiben – eine Art geheimen, ultra-technischen Code – um gute Ergebnisse zu erzielen. Aber hier ist die Wahrheit: Das ist nicht nötig. Dieses Missverständnis ist der Grund, warum so viele Menschen aufgeben, bevor sie überhaupt beginnen.

Beim Schreiben von Prompts geht es nicht um Perfektion. Es geht darum, einfach, neugierig und im Gespräch zu sein.

In dem Moment, in dem du **aufhörst, dir Sorgen zu machen, es "richtig zu machen"** und **anfängst, die KI als dein neues Teammitglied zu betrachten**, ändert sich alles. Es wird einfacher, intuitiver und ja – sogar unterhaltsamer.

Dieser Leitfaden wird dir hoffentlich helfen, diese Denkweise zu entwickeln.

# **Kontext-Seele-Feedback Framework**

**Was ist Prompting?**

---

Prompting ist die Kunst, KI-Systemen klare, präzise Anweisungen für optimale Ergebnisse zu geben. Denke daran wie das Formulieren von Eingaben für einen brillanten Assistenten.

Je durchdachter du deine Prompts gestaltest, desto genauer, kreativer und nützlicher werden die Antworten der KI.

**Wie du die besten Ergebnisse erzielst**

---

Dies ist ein schlechter Prompt. Warum?

\[BILD\]

Dieser Prompt ist zu vage – es fehlen drei entscheidende Elemente: eine Zielgruppe (Persona), Hintergrundinformationen (Kontext) und spezifische Anforderungen für den endgültigen Beitrag (Format).

Ohne diese Schlüsselkomponenten kann die KI nur allgemeine Inhalte generieren, weil sie deine genauen Bedürfnisse nicht versteht. Du wirst wahrscheinlich von den Ergebnissen enttäuscht sein.

Die besten Ergebnisse von KI zu erhalten, basiert auf drei wesentlichen Elementen: Kontext, Seele und Feedback.
...
Mach dir keine Sorgen, dir all das zu merken. Mit Übung wird der Kontext-Seele-Feedback-Kreislauf zur zweiten Natur werden.

**Ein Gespräch \> Ein großer Prompt**

---

"Ein großer Prompt" ist normalerweise das, was du siehst, wenn du Prompting lernst. Um ehrlich zu sein, meine \[12 einsatzbereite KI-Prompts\] geben dir auch eine Liste großer Prompts.

Dies geschieht, weil es einfacher ist, dir alle Komponenten, die einen guten Prompt ausmachen, auf einmal zu zeigen.

\[BILD\]

Aber in Wirklichkeit musst du keine (und solltest keine) großen Prompts schreiben.

Wenn du die KI als Kooperationspartner betrachtest und deine Prompts kürzer hältst, wirst du mehr menschliche Erkenntnisse und Präferenzen einfließen lassen, die die KI-Ausgaben verbessern.

\[BILD\]

Dies wird die Qualität deiner Ausgaben massiv verbessern. Zusammenarbeit ist der Schlüssel :)

# **Wie man \<Kontext\> setzt**

\[BILD\]

## **Konzentriere dich beim Setzen des Kontexts auf diese 5 Schlüsseleingaben.**

Sie sind nach Wichtigkeit geordnet. Du musst der KI zum Beispiel mitteilen, was ihre "Aufgabe" ist, um ein vernünftig gutes Ergebnis zu erhalten. Aber wenn du "Zielgruppe" weglässt, bekommst du trotzdem ein akzeptables Ergebnis.
...
Teile der KI mit, was du möchtest. Sei klar und spezifisch, damit sie genau weiß, was zu tun ist.
...
KI ist gut darin, ein Experte zu sein. Teile der KI mit, welche Rolle sie übernehmen soll.
...
Teile der KI mit, wie du dir das Ergebnis vorstellst. Das bedeutet oft, genau das Ausgabebeispiel einzufügen, damit sie darauf Bezug nehmen kann.
...
Teile der KI mit, welche Art von Ausgabe du haben möchtest. Z.B. ein Angebot, eine E-Mail, eine Gliederung, eine Präsentationsgliederung, eine Q\&A.
...
Teile der KI mit, für wen diese Ausgabe bestimmt ist. Wenn die KI die Zielgruppe versteht, wird sie die Antwort speziell darauf zuschneiden.
...
## **Hier sind die drei kreativen Eingaben, die du mit der KI teilen kannst.**

Diese Eingaben stellen sicher, dass die Ausgaben personalisiert und einzigartig für dich sind.
...
Teile, was du weißt, um die KI zu leiten. Gib ihr deine Ideen, Erkenntnisse oder sogar ein kurzes Brainstorming, um zu beginnen.
...
Kannst du einen bescheidenen und ermutigenden Ton verwenden, um diesen Abschnitt zu schreiben?"\*
...
Sage der KI genau, wie sich die Ausgabe anfühlen soll. Deine Vorlieben machen den ganzen Unterschied.
...
Lass die KI wissen, worauf sie sich konzentrieren und was sie vermeiden soll.
...
## **Lass die KI immer wissen, was du denkst.**

Ob du es liebst, nicht magst oder mehr Optionen möchtest, lass es die KI wissen — sie lernt deinen Stil und deine Vorlieben im Laufe der Zeit kennen.
...
Zeige, was funktioniert. Lass die KI wissen, wenn sie etwas gut trifft, damit sie auf diesem Erfolg aufbauen kann.
...
Sei klar darüber, was nicht funktioniert. Erkläre die Lücken und wie es besser gemacht werden kann.
...
Bitte um mehr Optionen oder Anpassungen, um die Ausgabe weiter zu verfeinern.
...
## **Hier sind die 8 Bereiche, auf die du dich konzentrieren kannst, wenn du neu in der Zusammenarbeit mit KI bist.**
...
Auf dieser Seite erfährst du den 3-Schritte-Prozess, den ich für jede Aufgabe verwende.

## **1\. Wenn du eine grobe Idee hast und sie erweitern möchtest**

Hier ist, wie du diesen Funken in etwas viel Größeres verwandeln kannst:
...
## **2\. Wenn du deine Idee in eine Gliederung umwandeln willst**

Hier ist, wie du es in nur drei Schritten schaffen kannst:
...
## **3\. Wenn du zu einem Thema recherchieren willst**

Manchmal beginnt die beste Recherche damit, die KI die Führung übernehmen zu lassen. Hier ist, wie du sie anleitest, Beispiele, Datenpunkte und frische Perspektiven für dein Projekt zu entdecken:
...
## **4\. Wenn du Titel und Überschriften erstellen möchtest**

Du kannst unzählige kreative Variationen erkunden und die eine finden, die klickt.
...
## **5\. Wenn du ein Angebot schreiben möchtest**

Ein starkes Angebot spricht direkt zum Entscheidungsträger und lässt ihn denken: "Ja, das ist genau das, was ich brauche." Hier ist, wie du eines mit KI erstellst:
...
## **6\. Wenn du eine Präsentation erstellen möchtest**

Hier ist, wie du deine Ideen in eine klare, wirkungsvolle Präsentation verwandelst:
...
## **7\. Wenn du eine E-Mail-Pitch schreiben möchtest**

Eine E-Mail-Pitch hat eine Aufgabe: Aufmerksamkeit erregen und sie sagen lassen: "Ich bin interessiert\!" Hier ist, wie du eine erstellst:
...
## **8\. Wenn du Besprechungsnotizen nutzen möchtest, um deinen Pitch zu verbessern**

Deine Besprechungsnotizen können eine Goldgrube für Fortschritte sein – wenn du weißt, wie du sie nutzt. Hier ist, wie du sie in umsetzbare nächste Schritte verwandelst:
...
## **Hier sind die Tipps, die ich mir gewünscht hätte, als ich anfing, ChatGPT zu nutzen.**

### **1\. Formate spezifizieren (JA)**

Wenn du ChatGPT eine Frage stellst, kannst du ihm sagen, in welchem Format es antworten soll. Das stellt sicher, dass du die Informationen schnell aufnehmen kannst.

"Verwende h2 als Überschrift und erkläre jeden Punkt mit maximal 3 Aufzählungspunkten."

---

### **2\. Änderungen fett markieren (JA)**

Wenn du etwas bearbeitest, bitte ChatGPT, alle Änderungen in **fett** zu markieren. Das ist eine schnelle und einfache Möglichkeit, zu sehen, was neu ist.

"Markiere alle Änderungen in **fett**"

---

### **3\. Sei präzise bei Wortzahlen (JA)**

Wenn du ein Limit hast, definiere es klar.

"Schreibe eine 50-Wörter-Zusammenfassung" "Beschränke dies auf drei Sätze."

---

### **4\. Verwende "Merke dir" und "Vergiss" (JA)**

Du kannst der KI direkt sagen, "merke dir" oder "vergiss" etwas Wichtiges über dich, deine Vorlieben oder den Kontext deiner Gespräche.

"Merke dir, dass mein bevorzugter Schreibstil professionell, aber gesprächig ist." "Vergiss, dass ich in London lebe; ich bin nach Hongkong gezogen."

---

### **5\. Ermutige die KI, Fragen zu stellen (JA)**

ChatGPT liebt mehr Informationen, kann aber schüchtern sein, zu fragen. Du kannst ihm das proaktiv anbieten.

"Stelle mir jede Frage, wenn sie helfen kann, bessere Ergebnisse zu erzielen. Frage, bevor du beginnst zu generieren. Danke."

---

### **6\. Abschnitte teilen (JA)**

Für längere Prompts verwende `---`, um die Dinge aufzuteilen. Es hilft ChatGPT, alles besser zu verarbeiten und hält deine Ideen ordentlich und aufgeräumt.

---

### **7\. Verwende Klammern für Anweisungen (JA)**

Setze deine Anweisungen in eckige Klammern, wie hier: `[Mache das witzig und unbeschwert.]` Das ist eine großartige Möglichkeit, den Ton oder Stil zu leiten.

Du kannst auch geschweifte Klammern verwenden, um mehrere Auswahlmöglichkeiten und Wege innerhalb eines einzelnen Prompts anzubieten, wie hier: `Diskutiere die Vorteile von {Fernarbeit | Büroarbeit | Hybridarbeitsmodellen} in der heutigen Geschäftswelt.`

---

### **8\. Bitte um Optionen (JA)**

Nicht sicher, was du willst? Brainstorming mit ChatGPT.

"Gib mir 3 Variationen davon." "Zeige mir 5 Überschriftenideen."

---

### **9\. Füge Erklärungen inline hinzu**

Möchtest du unterwegs lernen? Bitte um Erklärungen inline. Das ist eine großartige Möglichkeit, Einblicke zu bekommen.

"Erkläre jeden Satz in Klammern."

---

### **10\. Verwende Platzhalter (JA)**

Wenn du Vorlagen erstellst, machen Platzhalter wie `[NAME]` oder `[DATUM]` es einfach, sie für verschiedene Situationen wiederzuverwenden und anzupassen.

---

### **11\. Kombiniere Anweisungen und Ausgabe (JA)**

Manchmal brauchst du mehr als nur den Inhalt – wie Tipps, wie du ihn selbst erstellen kannst. Bitte um beides.

"Schreibe einen Vorschlag und füge Tipps hinzu, damit ich selbst einen erstellen kann."

---

### **12\. Erstelle verschachtelte Listen (JA)**

Brauchst du mehr Details? Bitte um Listen mit Unterpunkten.

"Teile das in Aufzählungspunkte mit Unterpunkten unter jedem Punkt auf."

---

### **13\. Bitte um Gründe für Bearbeitungen (JA)**

Wenn du etwas bearbeitest, bitte ChatGPT zu erklären, warum es Änderungen vorgenommen hat. Das ist eine großartige Möglichkeit, zu lernen und dein eigenes Schreiben zu verbessern.

"Kannst du diesen Artikel basierend auf \[deinen Ansichten und Vorlieben\] umschreiben und erklären, warum du diese Änderungen vornimmst?"

---

### **14\. Experimentiere mit Bildern (JA)**

ChatGPT kann Bilder beschreiben oder sogar Ideen für KI-generierte Kunst generieren. Wenn du ein Bild hochlädst, kannst du darum bitten, einen bestimmten Stil zu treffen – obwohl es noch nicht perfekt ist.

# **12 einsatzbereite KI-Prompts**

## **Hier sind 12 Prompt-Vorlagen, die dir helfen, Arbeit schneller zu erledigen.**

Das Ziel ist nicht, große Prompts zu schreiben. Es ist nur einfacher, es dir auf diese Weise zu zeigen.

Idealerweise wirst du im Gespräch mit deiner KI zusammenarbeiten und jeweils ein Stück Information teilen.

# **Zum Brainstorming / Lernen**

### **1\. KI-Prompt: Extrahiere Erkenntnisse aus Langform-Inhalten und verwandle sie in umsetzbare Richtlinien**
...
Du bist ein Experte für Inhaltsanalyse und außergewöhnlich gut darin, Schlüsselideen und Themen in komplexen Informationen zu identifizieren. Du bist spezialisiert darauf, dichte, langformatige Inhalte (wie Podcasts, YouTube-Videos und Artikel) verdaulich und umsetzbar zu machen. Du excellierst darin, große Informationsmengen in klare, strukturierte Richtlinien umzuwandeln, die anderen helfen, das Thema weiter zu erkunden. Deine Fähigkeit, verborgene Erkenntnisse aufzudecken, zum Nachdenken anregende Fragen zu stellen und die Kernbotschaft hervorzuheben, macht deine Arbeit unschätzbar für diejenigen, die ein tieferes Verständnis suchen.

Deine Aufgabe ist es, ein Transkript eines Langform-Inhalts in eine strukturierte Richtlinie umzuwandeln.

\<Hier ist die Präferenz\>
...
Verwende eine App wie [Voicepal](https://apps.apple.com/no/app/voicepal-your-ai-ghostwriter/id6471552007), um aufzunehmen und in ein Transkript umzuwandeln:

\<Hier ist der Kontext\>

Du bist ein Experte für Inhaltsanalyse und wirklich gut darin, Schlüsselideen und Themen zu erkennen. Du hast ein Talent dafür, komplexe Informationen so zu organisieren, dass sie leicht zu verstehen und umzusetzen sind. Du bist großartig darin, Rohgedanken in klare, strukturierte Richtlinien umzuwandeln. Du hast ein echtes Talent dafür, das Herz des Inhalts zu verstehen und zu wissen, wohin es weitergeführt werden kann. Deine Fähigkeit, aufschlussreiche Fragen zu stellen und tiefer in die Kernbotschaft einzudringen, hilft dabei, vage Ideen in etwas Solides und Erforschbares zu verwandeln.

Deine Aufgabe ist es, ein Sprachtranskript einer Rohidee in eine strukturierte Richtlinie umzuwandeln, die hilft, das Thema weiter zu erkunden.
...
### **3\. KI-Prompt: Extrahiere Erkenntnisse aus Meeting-Transkripten und verwandle sie in umsetzbare Richtlinien**

\<Hier ist der Kontext\>

Du bist ein Experte für Inhaltsanalyse, hochqualifiziert darin, wertvolle Erkenntnisse aus Meeting-Diskussionen zu extrahieren. Du excellierst darin, Schlüsselthemen zu identifizieren, Entscheidungen zu klären und umsetzbare Erkenntnisse aus komplexen Gesprächen zu destillieren. Deine Fähigkeit, Erkenntnisse in klare, organisierte Richtlinien zu strukturieren, hilft Teams, ihre Aktionen abzustimmen und ihr Verständnis der Meeting-Ergebnisse zu vertiefen.

Deine Aufgabe ist es, ein Meeting-Transkript in eine strukturierte Richtlinie umzuwandeln, die Schlüsselpunkte, Entscheidungen und Folgemaßnahmen hervorhebt und so eine bessere Zusammenarbeit und Produktivität ermöglicht.
...
### **4\. KI-Prompt: Generiere eine Liste von Fragen, um ein Thema tief zu erkunden**

\<Hier ist der Kontext\> Du bist ein Experte für Konversation und kreatives Denken, geschickt darin, zum Nachdenken anregende, offene Fragen zu formulieren. Dein Ziel ist es, tief zuzuhören, die Nuancen eines Themas zu verstehen und geschichtete Fragen zu generieren, die helfen, Erkenntnisse aufzudecken und bedeutungsvolle Erkundung anzuregen. Du excellierst darin, Fragen zu erstellen, die mit einfachen Ideen beginnen und schrittweise zu tieferen, komplexeren Reflexionen führen. Deine Fähigkeit, Fragen auf den spezifischen Kontext eines Gesprächs oder Transkripts zuzuschneiden, stellt sicher, dass die Diskussion relevant und aufschlussreich bleibt.

Deine Aufgabe ist es, eine Rohidee, ein Transkript oder Brainstorming-Notizen zu nehmen und eine Liste offener Fragen zu generieren. Diese Fragen sollen helfen, tiefer in das Thema einzutauchen und neue Perspektiven zu entdecken. Sie sollten mit einfachen, oberflächlichen Fragen beginnen und schrittweise zu tieferen, zum Nachdenken anregenden Fragen übergehen.

\<Hier ist die Präferenz\> Dies ist die Struktur der Fragen:

Ebene 1: Grundlegende Fragen Beginne mit unkomplizierten, leicht zu beantwortenden Fragen, um Kontext und oberflächliches Verständnis zu etablieren.

Ebene 2: Erkundende Fragen Gehe über zu Fragen, die Ursachen, Wirkungen oder Beziehungen innerhalb des Themas erkunden.

Ebene 3: Reflektierende Fragen Gehe tiefer auf Motivationen, Implikationen und potenzielle Ergebnisse ein, um eine durchdachte Analyse anzuregen.

Ebene 4: Visionäre Fragen Ende mit Fragen, die Kreativität, zukunftsorientiertes Denken oder strategische Erkenntnisse inspirieren.

Deine Fragen sollten auf die spezifischen Details und Themen des Transkripts oder der Idee zugeschnitten sein.

Bitte mich als Nächstes um die Rohidee oder das Transkript und beginne noch nicht mit der Verarbeitung.

# **Um aus einem Rohtranskript zu erstellen**

### **1\. KI-Prompt: Verwandle eine Sprachnotiz in Social-Media-Beiträge für alle Plattformen**

\<Hier ist der Kontext\> Du bist ein Experte für Social-Media-Strategie und Content-Erstellung. Du bist außergewöhnlich gut darin, rohe, unstrukturierte Inhalte zu nehmen und sie in überzeugende Beiträge umzuwandeln, die auf verschiedene Plattformen zugeschnitten sind. Du verstehst die Nuancen verschiedener Social-Media-Zielgruppen und erstellst Inhalte, die das Engagement maximieren, während sie der ursprünglichen Botschaft treu bleiben. Deine Fähigkeit, eine einzelne Sprachnotiz in plattformspezifische Beiträge zu verwandeln, ist unschätzbar für die Schaffung einer konsistenten, wirkungsvollen Online-Präsenz.

Deine Aufgabe ist es, eine Sprachnotiz in Social-Media-Beiträge umzuwandeln, die für LinkedIn, X, Threads und Bluesky optimiert sind.
...
### **2\. KI-Prompt: Verwandle eine Sprachnotiz in einen überzeugenden Artikel**

\<Hier ist der Kontext\>

Du bist ein Experte für Inhaltsanalyse, geschickt darin, Rohgespräche in wirkungsvolle schriftliche Inhalte zu verwandeln. Deine Stärke liegt darin, Schlüsselideen zu identifizieren, Erkenntnisse zu destillieren und sie in eine ansprechende Erzählung zu strukturieren. Du excellierst darin, Artikel zu verfassen, die nicht nur informieren, sondern auch die Perspektiven der Leser herausfordern, indem du Storytelling, Metaphern und gesprächige Sprache verwendest, um auf einer tieferen Ebene mit dem Publikum in Verbindung zu treten.

Deine Aufgabe ist es, eine Sprachnotiz zu nehmen und sie in einen Artikel zu verwandeln, der sowohl falsche Überzeugungen herausfordert als auch eine überzeugende wahre Überzeugung mit Beweisen und Argumenten präsentiert. Der endgültige Artikel sollte Leser mit Klarheit, emotionaler Resonanz und einer soliden logischen Struktur ansprechen.
...
### **3\. KI-Prompt: Verwandle eine Sprachnotiz in einen überzeugenden Vorschlag**

\<Hier ist der Kontext\>

Du bist ein Experte für Inhaltsanalyse mit einem Talent dafür, Gespräche in überzeugende Vorschläge zu verwandeln. Du excellierst darin, Schlüsselideen zu identifizieren, sie in überzeugende Argumente zu organisieren und Vorschläge zu verfassen, die herausstechen. Deine Stärke liegt darin, Klarheit und Fokus zu schaffen und gleichzeitig den einzigartigen Wert eines Projekts hervorzuheben.

Deine Aufgabe ist es, eine Sprachnotiz in einen Vorschlag umzuwandeln, der die Essenz, Struktur und das Wertversprechen des Projekts auf eine Weise kommuniziert, die zum Handeln inspiriert.
...
### **4\. KI-Prompt: Verwandle eine Sprachnotiz in eine Liste von Titeln \+ Untertiteln**

\<Hier ist der Kontext\>

Du bist ein Experte für Texterstellung mit einem Talent dafür, die Essenz eines Gesprächs zu identifizieren und es in fesselnde Titel und Untertitel zu übersetzen. Du excellierst darin, Variationen zu generieren, die Klarheit, Interesse und Kreativität ausbalancieren, was es einfach macht, die perfekte Übereinstimmung zu finden. Deine Fähigkeit, Schlüsselideen in prägnante Phrasen zu destillieren, stellt sicher, dass die Titel und Untertitel Aufmerksamkeit erregen und gleichzeitig die Kernbotschaft effektiv vermitteln.

Deine Aufgabe ist es, ein Gesprächstranskript in eine Liste von Titeln und Untertiteln zu verwandeln und dabei mehrere Variationen zur Auswahl anzubieten.
...
### **5\. KI-Prompt: Verwandle Interview-Notizen in eine Kunden-Fallstudie**

\<Hier ist der Kontext\> Du bist ein Experte für Storytelling und Content-Strategie, geschickt darin, Rohinterviews in überzeugende Kunden-Fallstudien zu verwandeln. Du excellierst darin, Schlüsselhighlights zu identifizieren, wirkungsvolle Zitate zu extrahieren und sie zu ansprechenden Erzählungen zu verweben. Deine Fähigkeit, unterhaltsame, nachvollziehbare und überzeugende Geschichten zu erstellen, macht dich zu einer unschätzbaren Ressource, um Kundenerfolge auf eine Weise zu präsentieren, die bei potenziellen Käufern Anklang findet.

Deine Aufgabe ist es, ein Rohtranskript eines Kundeninterviews in eine gut strukturierte Fallstudie zu verwandeln. Das Ziel ist es, eine ansprechende Geschichte zu erstellen, die hervorhebt, wie unser Produkt das Problem des Kunden gelöst und echten Wert geliefert hat. Die Zielgruppe für diese Geschichte umfasst potenzielle Kunden, die unser Produkt in Betracht ziehen und es mit Konkurrenten vergleichen.

\<Hier ist die Präferenz\> Dies ist die Struktur für die Fallstudie:
...
Bitte mich als Nächstes um das Interview-Transkript und beginne noch nicht mit der Verarbeitung.

### **6\. KI-Prompt: Generiere ein Kreativ-Briefing aus einer Brainstorming-Sitzung**

\<Hier ist der Kontext\> Du bist ein Experte für Projektstrategie und kreative Planung. Du spezialisierst dich darauf, unstrukturierte Ideen und Diskussionen in klare, umsetzbare Kreativ-Briefings zu destillieren. Deine Fähigkeit, Schlüsselziele zu identifizieren, Prioritäten zu organisieren und wesentliche Details zu erfassen, stellt sicher, dass alle Beteiligten aufeinander abgestimmt sind und auf dasselbe Ziel hinarbeiten. Du verstehst die Wichtigkeit, Pläne zu dokumentieren, um eine einzige Wahrheitsquelle zu schaffen, die leicht zu referenzieren und zu teilen ist.

Deine Aufgabe ist es, Notizen aus einer Brainstorming-Sitzung zu nehmen und sie in ein poliertes Kreativ-Briefing zu verwandeln. Dieses Dokument wird als Fahrplan dienen und sicherstellen, dass alle am Projekt Beteiligten – intern und extern – auf derselben Seite sind.

\<Hier ist die Präferenz\> Dies ist die Struktur des Kreativ-Briefings. Du musst nicht jeden Abschnitt einbeziehen, aber decke die relevanten basierend auf der Brainstorming-Sitzung ab:

Marken- oder Projekterklärung Fasse die Essenz der Marke oder des Projekts in ein oder zwei Sätzen zusammen.

Schlüsselziele/Herausforderungen Hebe die Hauptziele des Projekts und alle signifikanten zu überwindenden Hürden hervor.

Zielgruppe Beschreibe, für wen dieses Projekt bestimmt ist, einschließlich Zielgruppen-Personas oder wichtiger demografischer Daten.

Hauptkonkurrenten Liste Konkurrenten und ihre Positionierung auf, falls zutreffend.

Unternehmenswerte/Marktpositionierung Füge alle relevanten Unternehmenswerte oder wie die Marke/das Produkt im Markt positioniert ist ein.

Kampagnenkanäle Spezifiziere, auf welche Kanäle sich die Kampagne konzentrieren wird (z.B. Social Media, Bannerwerbung, Print).

Zeitpläne und Lieferungen Skizziere den Projektzeitplan, wichtige Meilensteine und endgültige Lieferungen.

Stakeholder Identifiziere Schlüsselpersonen oder Teams, die am Projekt beteiligt sind.

Inspiration und Ressourcen Verlinke oder beschreibe inspirierendes Material oder Referenzressourcen aus der Brainstorming-Sitzung.

Markenrichtlinien Füge alle markenspezifischen Regeln oder Designrichtlinien ein, die zu befolgen sind.

Kundenvision Erfasse alle spezifischen Kundeneingaben, Ziele oder Wünsche, die besprochen wurden.

Umfang Definiere klar, was im Projekt enthalten ist und was nicht.

Bitte mich als Nächstes um die Brainstorming-Notizen und beginne noch nicht mit deren Verarbeitung.

# **Um bestehende Arbeit neu zu gestalten**

### **1\. KI-Prompt: Verwandle eine Gliederung in präsentationsfertigen Text**

Sobald du den präsentationsfertigen Text hast, kannst du [Gamma](https://gamma.app/) verwenden, um die Folien zu generieren.

\<Hier ist der Kontext\>

Du bist ein Experte für Inhaltsanalyse und Präsentation, geschickt darin, komplexe Informationen in prägnante, wirkungsvolle Präsentationen zu destillieren. Du excellierst darin, die Kernbotschaft einer Kursgliederung zu verstehen und sie in klaren, präsentationsfertigen Inhalt zu übersetzen. Dein Ziel ist es, Folienkürze mit detaillierten Sprechernotizen auszubalancieren und so Klarheit und Engagement zu gewährleisten.

Deine Aufgabe ist es, eine Gliederung in präsentationsfertigen Text zu transformieren, wobei jede Folie eine klare Botschaft vermittelt und gleichzeitig ausreichend Details in den Sprechernotizen bereitstellt.
...
### **2\. KI-Prompt: Analysiere Feedback und empfehle umsetzbare Folgemaßnahmen**

\<Hier ist der Kontext\> Du bist ein Experte für Feedback-Analyse und Strategie. Du spezialisierst dich darauf, große Mengen an Feedback zu überprüfen und in umsetzbare Erkenntnisse zu destillieren. Du excellierst darin, Muster zu identifizieren, die wirkungsvollsten Kommentare hervorzuheben und Feedback basierend auf Relevanz zu kategorisieren. Deine Fähigkeit, zu gruppieren, zusammenzufassen und Ergebnisse visuell zu präsentieren, macht es für Stakeholder einfach, die Schlüsselerkenntnisse zu verstehen und entsprechende Maßnahmen zu ergreifen. Du bist auch geschickt darin, zu bestimmen, welche Rollen am engsten mit spezifischem Feedback verbunden sind, und stellst so sicher, dass Folgemaßnahmen an die richtigen Personen geleitet werden.

Deine Aufgabe ist es, Feedback zu einem Event, Produkt oder Service zu analysieren. Da die Art des Unternehmens oder des Feedbacks variieren kann, benenne die Rolle, die am relevantesten ist, um auf das Feedback zu reagieren (z.B. Marketing, Kundensupport, Produktdesign). Priorisiere umsetzbares Feedback und gruppiere ähnliche Punkte, um eine Zusammenfassung bereitzustellen.

\<Hier ist die Präferenz\> Dies ist die Struktur der Analyse:
...
# **1-Seiten-KI-Prompt-Spickzettel**
