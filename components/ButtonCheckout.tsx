...
// Temporarily redirect to Landsiedel checkout instead of Stripe
const CHECKOUT_URL = "https://www.landsiedel-seminare.de/nlp/seminare/produktivitaets-werkstatt.php";

/**
 * Checkout button - temporarily redirects to Landsiedel
 */
