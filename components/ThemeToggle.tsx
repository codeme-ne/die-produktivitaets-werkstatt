  ...
  return (
    <label className={`swap swap-rotate btn btn-circle btn-sm bg-base-200 text-base-content hover:bg-base-300 border-none ${className}`}>
      ...
      <input 
        ...
        checked={theme === "werkstatt-dark"} 
        aria-label="Farbmodus wechseln"
      />

      {/* sun icon - visible when checked (dark mode active -> show sun to switch to light) */}
      <svg
      ...
      {/* moon icon - visible when unchecked (light mode active -> show moon to switch to dark) */}
      <svg
